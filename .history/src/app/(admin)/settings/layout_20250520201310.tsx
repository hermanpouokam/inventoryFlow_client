...
export default function RootLayout({
  ...
  return (
    <SettingsDataProvider>
      <div className="grid grid-cols-1 xl:px-56 md:grid-cols-6 gap-3">
        <div className="col-span-1 md:col-span-2 sm:sticky relative top-10">
          <CardBodyContent className="divide-y truncate divide-neutral-200">
            {menu.map((el, i) => {
              const Icon = el.icon;
              return (
