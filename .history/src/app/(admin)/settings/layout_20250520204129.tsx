          ...
          <div className="sticky top-[70px] max-h-screen overflow-auto">
            <div className="">
              {menu.map((el, i) => {
                const Icon = el.icon;
                return (
                  <div key={i} className="w-full px-">
                    <Link
                      href={el.link}
                      className={cn(
                        "text-gray-800 py-4 text-base font-medium flex items-center justify-start truncate max-w-full overflow-x-hidden hover:bg-white px-2",
