    ...
    <SettingsDataProvider>
      <div className="grid grid-cols-1 md:grid-cols-6 min-h-screen gap-3 xl:px-56">
        ...
        <div className="md:col-span-2">
          <div className="sticky top-[70px] max-h-screen overflow-auto">
            <div className="">
              {menu.map((el, i) => {
                const Icon = el.icon;
                return (
                  <div key={i} className="w-full">
                    <Link
                      href={el.link}
                      className={cn(
                        "text-gray-800 py-4 text-base font-medium flex items-center justify-start truncate max-w-full overflow-x-hidden hover:bg-white px-2 pr-5",
                    ...
                    >
                      ...
                      <div>
                        {el.name}
                        <p className="text-muted-foreground capitalize text-xs font-normal w-full">
                          {el.subText}
                        </p>
                      </div>
                    </Link>
