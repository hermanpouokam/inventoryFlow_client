...
export default function Profile() {
    ...
    const { t: tCommon } = useTranslation('words')
        ...
        <div>
            <div className="space-y-2">
                ...
                <div className="relative w-24 h-24 rounded-full ">
                    <Tooltip title={tCommon('cancel')} placement="right-start">
                        <Button className="absolute right-0 -top-2 w-4 h-8 rounded-full" variant={'ghost'}>
                            <span>X</span>
                        </Button>
                    </Tooltip>
                    <img
