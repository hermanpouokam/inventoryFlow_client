...
export default function Page() {
  ...
  const [username, setUsername] = useState(user.us);
  ...
  useEffect(() => {
    ...
    instance.get('/check-user', { params: { username: debouncedUsername } })
      .then(response => {
        ...
        <form autoComplete="off" onSubmit={onSubmit} >
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 items-center gap-1.5 ">
            ...
            <div className="sm:col-span-1 md:col-span-2">
              ...
              />
              {usernameExists && (
                <p style={{ color: 'red' }}>Ce nom d’utilisateur est déjà pris</p>
              )}
            </div>
          </div>
