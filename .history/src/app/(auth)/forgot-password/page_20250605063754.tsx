...
export default function Page() {
    ...
    const handleConfirm = async () => {
        if (valuesM.new_password != values.confirm_password) {
        ...
        try {
            const res = await instance.post(`/verify-otp/`, { password: valuesM.confirm_password }, { withCredentials: true })
        } catch (error) {
            console.log(error)
        }
    }
                        ...
                        <div className="">
                            ...
                            <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
                                <div className="space-y-5">
                                    ...
                                    <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
                                        <form onSubmit={(e) => handleSubmit(e, handleConfirm)} method="POST" className="space-y-4">
