...
export default function Page() {
  ...
  return (
    <main className=" items-center justify-center">
      {error && (
        <h3 className="text-red-500 bg-red-100 p-3 px-4 text-center rounded border border-red-500 mb-5">
          {error}
        </h3>
      )}
      <div className="md:px-16 md:py-10 sm:px-10 px-5 rounded bg-white border relative border-neutral-200">
        {loading && (
          <div className="absolute top-0 left-0 right-0 w-full h-full bg-[rgba(255,255,255,.2 )] z-[999] animate-in">
            <LinearProgress color="primary" />
          </div>
        )}
        <div className="sm:mx-auto flex-col justify-center items-center sm:w-full sm:max-w-sm">
          <img
            alt="InventoryFlow"
            src={logo.src}
