...
export default function Page() {
  ...
  const onSubmit = async (e: FormEvent<HTMLFormElement>, attemp: number = 0) => {
    e.preventDefault();
    if (attemp > 1) {
      return setError("Echec de creation du compte. Veuillez réessayer plus tard.")
    }
    try {
      setLoading(true);
      ...
      if (code == 'user_not_found') {
        console.log('echec de cretion nouvelle tentative')
