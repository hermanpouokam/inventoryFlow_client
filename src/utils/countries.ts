...
export const COUNTRY_NAMES: Record<string, string> = {
    AC: "Île de l'Ascension", AD: "Andorre", AE: "Émirats arabes unis", AF: "Afghanistan",
    AG: "Antigua-et-Barbuda", AI: "Anguilla", AL: "Albanie", AM: "Arménie",
    AO: "Angola", AR: "Argentine", AS: "Samoa américaines", AT: "Autriche",
    ...
    BJ: "Bénin", BL: "Saint-Barthélemy", BM: "Bermudes", BN: "Brunéi",
    BO: "Bolivie", BQ: "Pays-Bas caribéens", BR: "Brésil", BS: "Bahamas",
    BT: "Bhoutan", BW: "Botswana", BY: "Biélorussie", BZ: "Belize",
    CA: "Canada", CC: "Îles Cocos", CD: "Congo (RDC)", CF: "République centrafricaine",
    ...
    CX: "Île Christmas", CY: "Chypre", CZ: "Tchéquie",
    ...
    FI: "Finlande", FJ: "Fidji", FK: "Îles Falkland", FM: "Micronésie",
    FO: "Îles Féroé", FR: "France",
    GA: "Gabon", GB: "Royaume-Uni", GD: "Grenade", GE: "Géorgie",
    GF: "Guyane française", GG: "Guernesey", GH: "Ghana", GI: "Gibraltar",
    GL: "Groenland", GM: "Gambie", GN: "Guinée", GP: "Guadeloupe",
    GQ: "Guinée équatoriale", GR: "Grèce", GT: "Guatemala", GU: "Guam",
    GW: "Guinée-Bissau", GY: "Guyana",
    HK: "Hong Kong", HN: "Honduras", HR: "Croatie", HT: "Haïti", HU: "Hongrie",
    ID: "Indonésie", IE: "Irlande", IL: "Israël", IM: "Île de Man",
    IN: "Inde", IO: "Territoire britannique de l'océan Indien", IQ: "Irak",
    IR: "Iran", IS: "Islande", IT: "Italie",
    ...
    LK: "Sri Lanka", LR: "Libéria", LS: "Lesotho", LT: "Lituanie",
    LU: "Luxembourg", LV: "Lettonie", LY: "Libye",
    MA: "Maroc", MC: "Monaco", MD: "Moldavie", ME: "Monténégro",
    MF: "Saint-Martin", MG: "Madagascar", MH: "Îles Marshall",
    MK: "Macédoine du Nord", ML: "Mali", MM: "Myanmar", MN: "Mongolie",
    MO: "Macao", MP: "Îles Mariannes du Nord", MQ: "Martinique",
    ...
    PR: "Porto Rico", PS: "Palestine", PT: "Portugal", PW: "Palaos", PY: "Paraguay",
    QA: "Qatar",
