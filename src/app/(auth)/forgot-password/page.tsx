    ...
    return (
        <div className="relative w-full min-h-screen overflow-hidden">
            <main className="flex flex-col items-center min-h-screen justify-center p-10">
                <div className="sm:p-14 p-5 rounded bg-card relative  border">
                    {loading && (
                    ...
                    {error && (
                        <h3 className="text-red-500 max-w-[320px] sm:max-w-[385px] bg-red-100  text-center font-medium p-3 rounded border border-red-500 mb-5">
                            {tCommon(`${error}`)}
                        </h3>
                    )}
