    ...
    return (
        <main className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-md z-10">
                ...
                <div className="rounded-2xl p-8 backdrop-blur-sm bg-card/20 dark:bg-card/10 shadow-[0_0_10px_rgba(0,0,0,0.15)]" >
                    {error && (
                    ...
                    <form onSubmit={onSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                name="username"
                                required
                                className="w-full dark:bg-white/5 bg-neutral-500/5 border border-white/10 rounded-xl px-4 py-3 text-sm  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="•••••••••••"
                                    required
                                    className="w-full dark:bg-white/5 bg-neutral-500/5  border border-white/10 rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
                                />
