...
export default function Page({ params }: { params: { id: string } }) {
  ...
  const translations = React.useMemo(() => ({
    name: t("name"),
    empty_quantity: t("packaging.columns.empty_quantity"),
    full_quantity: t("packaging.columns.full_quantity"),
    sales_point_details: t("sales_points.singular"),
    category_details: t("bills.columns.category"),
    supplier_details: t("supplier.singular"),
    price: t("purchase_price"),
    created_at: t("created_on"),
    updated_at: t("bills.columns.updated_at"),
  }), [t]);
  ...
  if (error) {
    <div className="flex justify-center items-center h-full w-full">
      {t("packaging.errors.details_unavailable")}
    </div>;
  }
