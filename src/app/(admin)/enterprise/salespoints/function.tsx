...
const createAdditionalFee = async (data: any) => {
  try {
    const response = await instance.post(`/additional-fees/`, data, {
      withCredentials: true,
    });
    return response;
  } catch (error) {
...
export {
  createEmployee, createTax, createAdditionalFee, getRoles, getActionsPermissions,
